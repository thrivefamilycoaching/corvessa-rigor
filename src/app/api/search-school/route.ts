...
const STATE_TO_REGION: Record<string, string> = {
  ...
  "ON": "Canada", "BC": "Canada", "AB": "Canada", "QC": "Canada", "MB": "Canada", "SK": "Canada",
  "NS": "Canada", "NB": "Canada", "NL": "Canada", "PE": "Canada",
};
...
const SCHOOLS = [
  ...
  { name: "University of Toronto", state: "ON", enrollment: 73000, admitRate: 0.43, url: "utoronto.ca", testPolicy: "Test Optional" },
  { name: "University of Waterloo", state: "ON", enrollment: 40000, admitRate: 0.52, url: "uwaterloo.ca", testPolicy: "Test Optional" },
  { name: "Queen's University", state: "ON", enrollment: 26000, admitRate: 0.42, url: "queensu.ca", testPolicy: "Test Optional" },
  { name: "Western University", state: "ON", enrollment: 33000, admitRate: 0.50, url: "uwo.ca", testPolicy: "Test Optional" },
  { name: "McMaster University", state: "ON", enrollment: 33000, admitRate: 0.48, url: "mcmaster.ca", testPolicy: "Test Optional" },
  { name: "University of Ottawa", state: "ON", enrollment: 42000, admitRate: 0.55, url: "uottawa.ca", testPolicy: "Test Optional" },
  { name: "Carleton University", state: "ON", enrollment: 31000, admitRate: 0.68, url: "carleton.ca", testPolicy: "Test Optional" },
  { name: "York University", state: "ON", enrollment: 53000, admitRate: 0.65, url: "yorku.ca", testPolicy: "Test Optional" },
  { name: "Toronto Metropolitan University", state: "ON", enrollment: 38000, admitRate: 0.68, url: "torontomu.ca", testPolicy: "Test Optional" },
  { name: "University of Guelph", state: "ON", enrollment: 30000, admitRate: 0.58, url: "uoguelph.ca", testPolicy: "Test Optional" },
  { name: "University of Windsor", state: "ON", enrollment: 15000, admitRate: 0.72, url: "uwindsor.ca", testPolicy: "Test Optional" },
  { name: "Brock University", state: "ON", enrollment: 19000, admitRate: 0.72, url: "brocku.ca", testPolicy: "Test Optional" },
  { name: "Wilfrid Laurier University", state: "ON", enrollment: 19000, admitRate: 0.62, url: "wlu.ca", testPolicy: "Test Optional" },
  { name: "Trent University", state: "ON", enrollment: 10000, admitRate: 0.78, url: "trentu.ca", testPolicy: "Test Optional" },
  { name: "Lakehead University", state: "ON", enrollment: 8000, admitRate: 0.82, url: "lakeheadu.ca", testPolicy: "Test Optional" },
  { name: "Ontario Tech University", state: "ON", enrollment: 10000, admitRate: 0.78, url: "ontariotechu.ca", testPolicy: "Test Optional" },
  { name: "Nipissing University", state: "ON", enrollment: 5000, admitRate: 0.82, url: "nipissingu.ca", testPolicy: "Test Optional" },
  { name: "Laurentian University", state: "ON", enrollment: 6000, admitRate: 0.82, url: "laurentian.ca", testPolicy: "Test Optional" },
  { name: "McGill University", state: "QC", enrollment: 40000, admitRate: 0.38, url: "mcgill.ca", testPolicy: "Test Optional" },
  { name: "Concordia University", state: "QC", enrollment: 46000, admitRate: 0.62, url: "concordia.ca", testPolicy: "Test Optional" },
  { name: "Université Laval", state: "QC", enrollment: 43000, admitRate: 0.65, url: "ulaval.ca", testPolicy: "Test Optional" },
  { name: "Université de Montréal", state: "QC", enrollment: 45000, admitRate: 0.55, url: "umontreal.ca", testPolicy: "Test Optional" },
  { name: "Université du Québec à Montréal", state: "QC", enrollment: 40000, admitRate: 0.72, url: "uqam.ca", testPolicy: "Test Optional" },
  { name: "Université de Sherbrooke", state: "QC", enrollment: 31000, admitRate: 0.62, url: "usherbrooke.ca", testPolicy: "Test Optional" },
  { name: "Bishop's University", state: "QC", enrollment: 2600, admitRate: 0.72, url: "ubishops.ca", testPolicy: "Test Optional" },
  { name: "École de technologie supérieure", state: "QC", enrollment: 11000, admitRate: 0.55, url: "etsmtl.ca", testPolicy: "Test Optional" },
  { name: "University of British Columbia", state: "BC", enrollment: 55000, admitRate: 0.46, url: "ubc.ca", testPolicy: "Test Optional" },
  { name: "Simon Fraser University", state: "BC", enrollment: 30000, admitRate: 0.55, url: "sfu.ca", testPolicy: "Test Optional" },
  { name: "University of Victoria", state: "BC", enrollment: 22000, admitRate: 0.62, url: "uvic.ca", testPolicy: "Test Optional" },
  { name: "University of Northern British Columbia", state: "BC", enrollment: 3500, admitRate: 0.78, url: "unbc.ca", testPolicy: "Test Optional" },
  { name: "Royal Roads University", state: "BC", enrollment: 3000, admitRate: 0.82, url: "royalroads.ca", testPolicy: "Test Optional" },
  { name: "Kwantlen Polytechnic University", state: "BC", enrollment: 13000, admitRate: 0.82, url: "kpu.ca", testPolicy: "Test Optional" },
  { name: "Thompson Rivers University", state: "BC", enrollment: 10000, admitRate: 0.82, url: "tru.ca", testPolicy: "Test Optional" },
  { name: "University of Alberta", state: "AB", enrollment: 40000, admitRate: 0.48, url: "ualberta.ca", testPolicy: "Test Optional" },
  { name: "University of Calgary", state: "AB", enrollment: 33000, admitRate: 0.52, url: "ucalgary.ca", testPolicy: "Test Optional" },
  { name: "University of Lethbridge", state: "AB", enrollment: 8500, admitRate: 0.72, url: "ulethbridge.ca", testPolicy: "Test Optional" },
  { name: "MacEwan University", state: "AB", enrollment: 13000, admitRate: 0.78, url: "macewan.ca", testPolicy: "Test Optional" },
  { name: "Mount Royal University", state: "AB", enrollment: 11000, admitRate: 0.78, url: "mtroyal.ca", testPolicy: "Test Optional" },
  { name: "University of Manitoba", state: "MB", enrollment: 30000, admitRate: 0.62, url: "umanitoba.ca", testPolicy: "Test Optional" },
  { name: "University of Saskatchewan", state: "SK", enrollment: 26000, admitRate: 0.65, url: "usask.ca", testPolicy: "Test Optional" },
  { name: "University of Regina", state: "SK", enrollment: 15000, admitRate: 0.78, url: "uregina.ca", testPolicy: "Test Optional" },
  { name: "University of Winnipeg", state: "MB", enrollment: 9000, admitRate: 0.82, url: "uwinnipeg.ca", testPolicy: "Test Optional" },
  { name: "Dalhousie University", state: "NS", enrollment: 19000, admitRate: 0.55, url: "dal.ca", testPolicy: "Test Optional" },
  { name: "Memorial University of Newfoundland", state: "NL", enrollment: 18000, admitRate: 0.72, url: "mun.ca", testPolicy: "Test Optional" },
  { name: "University of New Brunswick", state: "NB", enrollment: 10000, admitRate: 0.72, url: "unb.ca", testPolicy: "Test Optional" },
  { name: "Saint Mary's University", state: "NS", enrollment: 7000, admitRate: 0.72, url: "smu.ca", testPolicy: "Test Optional" },
  { name: "Acadia University", state: "NS", enrollment: 3500, admitRate: 0.72, url: "acadiau.ca", testPolicy: "Test Optional" },
  { name: "St. Francis Xavier University", state: "NS", enrollment: 4500, admitRate: 0.68, url: "stfx.ca", testPolicy: "Test Optional" },
  { name: "Cape Breton University", state: "NS", enrollment: 5000, admitRate: 0.82, url: "cbu.ca", testPolicy: "Test Optional" },
];
