...
Your task is to analyze a student's transcript against their school's profile to evaluate the rigor of their course selections.
    ...
    Generate EXACTLY 30 colleges in the recommendedSchools array. Each school object must have:
    {
      ...
      "ncaaDivision": "<DI|DII|DIII|No Athletics Program>",
      "programs": ["<array of applicable programs from: Greek Life, ROTC, Study Abroad, Honors College, Co-op/Internship Program, Pre-Med, Pre-Law, Engineering, Nursing, Business School, Performing Arts>"]
    }

    NCAA DIVISION: For each school, provide the correct NCAA athletic division. Most large state universities are DI. Many small liberal arts colleges are DIII. Some mid-size schools are DII. Schools like Caltech or MIT with minimal athletics programs should be listed as their actual division. Only use "No Athletics Program" for schools that truly have no intercollegiate athletics.

    PROGRAMS: For each school, list which of the following programs are available: Greek Life, ROTC, Study Abroad, Honors College, Co-op/Internship Program, Pre-Med, Pre-Law, Engineering, Nursing, Business School, Performing Arts. Only include programs the school actually offers.
...
Provide your comprehensive rigor analysis in the specified JSON format. Remember: the recommendedSchools array MUST contain exactly 30 schools (10 reach, 10 match, 10 safety) with broad coverage across all 5 regions and all 5 size categories.`,
  ...
  try {
    ...
    const backupSchools: RecommendedSchool[] = [
      // MICRO - Northeast
      { name: "Williams College", url: "https://www.williams.edu", type: "reach", region: "Northeast", campusSize: "Micro", enrollment: 2000, matchReasoning: "Williams' rigorous liberal arts curriculum and small class sizes align well with this student's strong academic foundation.", ncaaDivision: "DIII", programs: ["Study Abroad", "Pre-Med", "Pre-Law"] },
      { name: "Colby College", url: "https://www.colby.edu", type: "match", region: "Northeast", campusSize: "Micro", enrollment: 2000, matchReasoning: "Colby's commitment to undergraduate research and global engagement align with this student's academic trajectory.", ncaaDivision: "DIII", programs: ["Study Abroad", "Pre-Med"] },
      { name: "Bates College", url: "https://www.bates.edu", type: "safety", region: "Northeast", campusSize: "Micro", enrollment: 1800, matchReasoning: "Bates' test-optional policy and emphasis on experiential learning make it an accessible option that values holistic preparation.", ncaaDivision: "DIII", programs: ["Study Abroad", "Pre-Med"] },
      // MICRO - Mid-Atlantic
      { name: "Haverford College", url: "https://www.haverford.edu", type: "match", region: "Mid-Atlantic", campusSize: "Micro", enrollment: 1400, matchReasoning: "Haverford's honor code and close-knit academic community foster intellectual engagement.", ncaaDivision: "DIII", programs: ["Study Abroad", "Pre-Med", "Pre-Law"] },
      { name: "Swarthmore College", url: "https://www.swarthmore.edu", type: "reach", region: "Mid-Atlantic", campusSize: "Micro", enrollment: 1600, matchReasoning: "Swarthmore's honors program and intellectual rigor attract students who thrive on academic challenge.", ncaaDivision: "DIII", programs: ["Study Abroad", "Engineering", "Pre-Med"] },
      // MICRO - South
      { name: "Rhodes College", url: "https://www.rhodes.edu", type: "safety", region: "South", campusSize: "Micro", enrollment: 2000, matchReasoning: "Rhodes' strong liberal arts tradition and Memphis location offer academics and community engagement.", ncaaDivision: "DIII", programs: ["Greek Life", "Study Abroad", "Pre-Med", "Pre-Law"] },
      { name: "Centre College", url: "https://www.centre.edu", type: "safety", region: "South", campusSize: "Micro", enrollment: 1500, matchReasoning: "Centre's guaranteed study abroad and high graduate school placement reflect its commitment to student success.", ncaaDivision: "DIII", programs: ["Greek Life", "Study Abroad", "Pre-Med", "Pre-Law"] },
      // MICRO - Midwest
      { name: "Grinnell College", url: "https://www.grinnell.edu", type: "match", region: "Midwest", campusSize: "Micro", enrollment: 1700, matchReasoning: "Grinnell's self-governed curriculum and strong mentorship suit students who take initiative.", ncaaDivision: "DIII", programs: ["Study Abroad", "Pre-Med"] },
      { name: "Kenyon College", url: "https://www.kenyon.edu", type: "match", region: "Midwest", campusSize: "Micro", enrollment: 1700, matchReasoning: "Kenyon's renowned writing program and close faculty relationships foster deep academic engagement.", ncaaDivision: "DIII", programs: ["Study Abroad", "Pre-Med", "Performing Arts"] },
      // MICRO - West
      { name: "Pomona College", url: "https://www.pomona.edu", type: "reach", region: "West", campusSize: "Micro", enrollment: 1800, matchReasoning: "Pomona's intimate environment and Claremont Consortium access offer both depth and breadth.", ncaaDivision: "DIII", programs: ["Study Abroad", "Pre-Med", "Pre-Law"] },
      { name: "Harvey Mudd College", url: "https://www.hmc.edu", type: "reach", region: "West", campusSize: "Micro", enrollment: 900, matchReasoning: "Harvey Mudd's STEM focus combined with liberal arts breadth suits analytically minded students.", ncaaDivision: "DIII", programs: ["Engineering", "Pre-Med"] },
      // SMALL - spread across regions
      { name: "Davidson College", url: "https://www.davidson.edu", type: "reach", region: "South", campusSize: "Small", enrollment: 2000, matchReasoning: "Davidson's honor code and rigorous academics attract students who thrive in challenging environments.", ncaaDivision: "DI", programs: ["Study Abroad", "Pre-Med", "Pre-Law"] },
      { name: "Bowdoin College", url: "https://www.bowdoin.edu", type: "reach", region: "Northeast", campusSize: "Small", enrollment: 2000, matchReasoning: "Bowdoin's commitment to the common good and strong science programs complement strong academic profiles.", ncaaDivision: "DIII", programs: ["Study Abroad", "Pre-Med"] },
      { name: "Bucknell University", url: "https://www.bucknell.edu", type: "match", region: "Mid-Atlantic", campusSize: "Small", enrollment: 3800, matchReasoning: "Bucknell's blend of liberal arts and professional programs provides flexibility for exploration.", ncaaDivision: "DI", programs: ["Greek Life", "ROTC", "Study Abroad", "Engineering", "Business School"] },
      { name: "Whitman College", url: "https://www.whitman.edu", type: "match", region: "West", campusSize: "Small", enrollment: 1500, matchReasoning: "Whitman's discussion-based classes and research opportunities foster intellectual engagement.", ncaaDivision: "DIII", programs: ["Study Abroad", "Pre-Med"] },
      { name: "Elon University", url: "https://www.elon.edu", type: "safety", region: "South", campusSize: "Small", enrollment: 4600, matchReasoning: "Elon's experiential learning focus and study abroad program suit well-rounded students.", ncaaDivision: "DI", programs: ["Greek Life", "Study Abroad", "Honors College", "Business School", "Performing Arts"] },
      { name: "College of Wooster", url: "https://www.wooster.edu", type: "safety", region: "Midwest", campusSize: "Small", enrollment: 2000, matchReasoning: "Wooster's Independent Study program gives every student a mentored research experience.", ncaaDivision: "DIII", programs: ["Study Abroad", "Pre-Med"] },
      // MEDIUM - spread across regions
      { name: "Georgetown University", url: "https://www.georgetown.edu", type: "reach", region: "Mid-Atlantic", campusSize: "Medium", enrollment: 7500, matchReasoning: "Georgetown's global focus and rigorous academics attract students with strong intellectual curiosity.", ncaaDivision: "DI", programs: ["Study Abroad", "Honors College", "Pre-Med", "Pre-Law", "Business School", "Nursing"] },
      { name: "Boston College", url: "https://www.bc.edu", type: "reach", region: "Northeast", campusSize: "Medium", enrollment: 10000, matchReasoning: "Boston College's Jesuit tradition of intellectual inquiry and service aligns with well-prepared students.", ncaaDivision: "DI", programs: ["Study Abroad", "Honors College", "Pre-Med", "Pre-Law", "Business School", "Nursing", "Engineering"] },
      { name: "Tulane University", url: "https://www.tulane.edu", type: "match", region: "South", campusSize: "Medium", enrollment: 8500, matchReasoning: "Tulane's service-learning requirement and vibrant campus culture appeal to engaged students.", ncaaDivision: "DI", programs: ["Greek Life", "ROTC", "Study Abroad", "Honors College", "Pre-Med", "Pre-Law", "Engineering", "Business School"] },
      { name: "Santa Clara University", url: "https://www.scu.edu", type: "match", region: "West", campusSize: "Medium", enrollment: 6000, matchReasoning: "Santa Clara's Silicon Valley location and Jesuit values combine career preparation with ethical formation.", ncaaDivision: "DI", programs: ["Study Abroad", "Engineering", "Business School", "Pre-Law"] },
      { name: "Marquette University", url: "https://www.marquette.edu", type: "safety", region: "Midwest", campusSize: "Medium", enrollment: 8000, matchReasoning: "Marquette's strong professional programs and supportive community suit motivated students.", ncaaDivision: "DI", programs: ["Greek Life", "ROTC", "Study Abroad", "Honors College", "Pre-Med", "Pre-Law", "Engineering", "Nursing", "Business School"] },
      { name: "Villanova University", url: "https://www.villanova.edu", type: "match", region: "Mid-Atlantic", campusSize: "Medium", enrollment: 7000, matchReasoning: "Villanova's Augustinian tradition and strong academics provide a values-centered education.", ncaaDivision: "DI", programs: ["Greek Life", "ROTC", "Study Abroad", "Honors College", "Pre-Med", "Pre-Law", "Engineering", "Nursing", "Business School"] },
      // LARGE - spread across regions
      { name: "University of Michigan", url: "https://www.umich.edu", type: "reach", region: "Midwest", campusSize: "Large", enrollment: 32000, matchReasoning: "Michigan's research excellence and breadth of programs attract top students nationwide.", ncaaDivision: "DI", programs: ["Greek Life", "ROTC", "Study Abroad", "Honors College", "Co-op/Internship Program", "Pre-Med", "Pre-Law", "Engineering", "Nursing", "Business School", "Performing Arts"] },
      { name: "University of Virginia", url: "https://www.virginia.edu", type: "reach", region: "Mid-Atlantic", campusSize: "Large", enrollment: 17000, matchReasoning: "UVA's student self-governance tradition and strong academics align with independent-minded students.", ncaaDivision: "DI", programs: ["Greek Life", "ROTC", "Study Abroad", "Honors College", "Pre-Med", "Pre-Law", "Engineering", "Nursing", "Business School"] },
      { name: "University of North Carolina", url: "https://www.unc.edu", type: "match", region: "South", campusSize: "Large", enrollment: 20000, matchReasoning: "UNC's combination of public university resources and strong liberal arts tradition offers excellent value.", ncaaDivision: "DI", programs: ["Greek Life", "ROTC", "Study Abroad", "Honors College", "Pre-Med", "Pre-Law", "Nursing", "Business School"] },
      { name: "University of Washington", url: "https://www.washington.edu", type: "match", region: "West", campusSize: "Large", enrollment: 36000, matchReasoning: "UW's research strength and Pacific Northwest setting attract students seeking academic excellence.", ncaaDivision: "DI", programs: ["Greek Life", "ROTC", "Study Abroad", "Honors College", "Co-op/Internship Program", "Pre-Med", "Pre-Law", "Engineering", "Nursing", "Business School"] },
      { name: "Boston University", url: "https://www.bu.edu", type: "match", region: "Northeast", campusSize: "Large", enrollment: 18000, matchReasoning: "BU's urban campus and wide range of programs provide diverse academic and experiential opportunities.", ncaaDivision: "DI", programs: ["Greek Life", "ROTC", "Study Abroad", "Honors College", "Co-op/Internship Program", "Pre-Med", "Pre-Law", "Engineering", "Nursing", "Business School", "Performing Arts"] },
